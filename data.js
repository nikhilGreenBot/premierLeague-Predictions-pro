...
// Wikipedia thumbnail API - freely accessible, no CORS issues
// Format: https://en.wikipedia.org/w/api.php?action=query&titles=FILE&prop=imageinfo&iiprop=url&format=json&origin=*
// Using direct Wikimedia thumb URLs which are publicly served
const TEAM_CRESTS = {
...
// Team fallback colors for when images fail to load
const TEAM_COLORS = {
  'Brighton': '#0057B8', 'Man Utd': '#DA291C', 'Burnley': '#6C1D45',
  'Wolves': '#FDB913', 'Crystal Palace': '#1B458F', 'Arsenal': '#EF0107',
  'Fulham': '#000000', 'Newcastle': '#241F20', 'Liverpool': '#C8102E',
...
const PREDICTIONS = {
  parth: {
    371: { home: 2, away: 2 }, 372: { home: 3, away: 1 }, 373: { home: 1, away: 2 },
    374: { home: 2, away: 1 }, 375: { home: 2, away: 1 }, 376: { home: 3, away: 2 },
    377: { home: 1, away: 2 }, 378: { home: 2, away: 2 }, 379: { home: 1, away: 2 },
    380: { home: 2, away: 1 },
  },
  akash: {
    371: { home: 2, away: 2 }, 372: { home: 2, away: 1 }, 373: { home: 1, away: 2 },
    374: { home: 1, away: 2 }, 375: { home: 3, away: 1 }, 376: { home: 3, away: 1 },
    377: { home: 1, away: 1 }, 378: { home: 1, away: 2 }, 379: { home: 2, away: 1 },
    380: { home: 2, away: 1 },
  },
  dadhichi: {},
};
...
function calcGW38Scores() {
  ...
  for (const player of PLAYERS) {
    ...
    for (const match of GW38_MATCHES) {
      ...
      const result = scorePredict(pred, { home: match.actualHome, away: match.actualAway });
      pts += result.pts;
